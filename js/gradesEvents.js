...
function insertClick(){
	...
	if(txtCourseName != "" && txtFinalGrade != "" && txtCredits != "")
	{
		...
		var newNaz =parseInt(txtCredits);
		var newGrade = parseInt(txtFinalGrade);
...
function displayList()
{
	...
	if(gradesList.itemList[index].isChecked){
		row+=" checked ";
		sigmaScores = sigmaScores + parseInt(item.FinalGrade)*parseInt(item.Credits);
		naz = naz + parseInt(item.Credits);
		counter++;
	}
